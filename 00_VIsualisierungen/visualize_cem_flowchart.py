...
FONT_SIZE_BOX = FONT_SIZE - 2
FONT_SIZE_SMALL = FONT_SIZE - 4
FONT_SIZE_PARAM = FONT_SIZE - 4.5
...
fig, ax = plt.subplots(figsize=(TEXTWIDTH_IN, TEXTWIDTH_IN * 1.6))
ax.set_xlim(-5, 5)
ax.set_ylim(-17.5, 2)
ax.set_aspect('equal')
ax.axis('off')
...
plt.tight_layout()
stem = os.path.join(os.path.dirname(__file__), "cem_flowchart")
save_ma_figure(fig, stem)
